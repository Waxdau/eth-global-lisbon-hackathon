...
export class BLSSigner extends Signer {
    ...
    constructor(blsSignerFactory: signer.BlsSignerFactory, domain: string, privateKey: string) {
        super();
        this.blsSigner = blsSignerFactory.getSigner(Buffer.from(domain), privateKey);
    }
